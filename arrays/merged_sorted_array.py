'''given two arrays merge them so that we can get one big sorted array 
we add the smaller element to  a new array and increment the index of the array 
of the array from which the element was added 
again we compare the elements of both arrays are repeat the procedure untill all the elements have been added '''
